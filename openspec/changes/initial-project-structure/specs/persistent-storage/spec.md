...
The system SHALL save all profiles to `~/.buildozer-manager/profiles.json` on every save operation.
...
The system SHALL save application-wide settings to `~/.buildozer-manager/settings.json`.
...
The system SHALL save user-defined custom scenarios to `~/.buildozer-manager/scenarios.json`.
