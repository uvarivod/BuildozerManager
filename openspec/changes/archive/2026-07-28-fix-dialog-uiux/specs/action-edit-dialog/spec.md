...
For built-in Action enum members, the edit dialog SHALL display all fields as disabled/read-only text inputs. No save or delete buttons SHALL appear. The dialog SHALL be created using `show_info_dialog()` from the dialog helper module.
