# Patch Back Functionality

## Purpose

Provide a patch that disables Android's predictive back gesture on Android 16+ by setting `android:enableOnBackInvokedCallback="false"` on the `<application>` tag in AndroidManifest templates.
