# Patch Selector Profile

## Purpose

Provide a multi-select patch chooser in the Profile Editor that allows users to select which registered patches apply to a profile, with patches dynamically populated from PatchRegistry.
