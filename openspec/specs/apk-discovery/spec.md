...
Locate the built APK file in the WSL `bin/` directory by matching the expected filename from `buildozer.spec`, and extract package metadata needed for installation and launch.
